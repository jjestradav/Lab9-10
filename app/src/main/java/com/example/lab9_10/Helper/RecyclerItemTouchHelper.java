package com.example.lab9_10.Helper;
...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            //check adapter
            if (this.listener.getClass().getSimpleName().equals("ListCursoActivity")) {
            ...
            } else if (this.listener.getClass().getSimpleName().equals("ListEstudianteActivity")) {
